    ...
    tooltip: {
      callbacks: {
        label: function (tooltipItem) {
          return `Gender Wise: ${tooltipItem.raw}`;
        },
      },
    },
    // title: {
...
const Chart1 = ({getGenderReportData}) => {
  const Chartdata = {
    labels: ['Male', 'Female', 'Other'],
    datasets: [
      {
        label: 'Sales',
        data: [getGenderReportData?.male, getGenderReportData?.female, getGenderReportData?.otherGender],
        backgroundColor: [
          '#22CFCF',
          '#FF6384',
          '#059BFF',
